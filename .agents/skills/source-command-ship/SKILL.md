...
description: Compatibility alias for the explicitly requested source-command-ship migrated command.
---

Use the maintained [ship skill](../ship/SKILL.md). This alias replaces
