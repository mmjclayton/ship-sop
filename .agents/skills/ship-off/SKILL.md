---
name: ship-off
description: Set ship-sop trigger mode to manual while preserving project configuration.
---
...
Use jq and a validated temporary file to change only .trigger.mode to "manual";
