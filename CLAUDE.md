...
P1-P10 shipped, P8 deferred. See `Backlog.md` for the authoritative list and any open follow-ups. Phase 2 (hardening — diagnostic mode, config schema warn, artifact retention, drift fixes) in flight.
...
*Auto-generated from `docs/recent-work/`. Last refreshed: 2026-07-27.*
